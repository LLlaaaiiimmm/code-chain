...
async def seed_data():
    """
    Seed NEW 120 problems: 30 Solidity + 30 Rust + 30 MOVE + 30 TVM
    Each with 15+ comprehensive tests and solved_count = 0
    """
    from seed_problems import get_problems
    
    # Get NEW 120 problem set
    # Distribution: 10 Junior + 10 Middle + 10 Senior per language
    # All problems have solved_count = 0
    # All problems have 15+ tests that check DIFFERENT values
